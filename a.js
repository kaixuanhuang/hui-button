(function (AD_CONFIG, LINKS, RT_CONFIG) {
    ...
    function la(a, b) {
        if ("function" === typeof b)for (var c in a)if (a.hasOwnProperty(c) && false === b.call(a, a[c], c))break
    }
    ...
    function ma(a) {
        ...
        if (!(a && "[object Object]" === Object.prototype.toString.call(a) && "isPrototypeOf" in a) || a.constructor && !b.call(a, "constructor") && !b.call(a.constructor.prototype, "isPrototypeOf"))return false;
        for (c in a);
    ...
    function A(a, b, c) {
        ...
        a.addEventListener ? a.addEventListener(e, d, false) : a.attachEvent && a.attachEvent("on" + e, d);
    ...
    function C(a, b, c) {
        ...
        for (var d = y.length, e = !c, f, g; d--;)f = y[d], f[1] !== b || f[0] !== a || !e && f[2] !== c || (g = f[4], f = f[3], a.removeEventListener ? a.removeEventListener(g, f, false) : a.detachEvent && a.detachEvent("on" + g, f), y.splice(d, 1))
    }
    ...
    F = function (a, b, c) {
        var d, e, f = a.length;
        if ("function" === typeof b)for (e = 0; e < f && (d = a[e], d = b.call(c || a, d, e), false !== d); e++);
    };
    ...
    function ra(a) {
        var b = [], c;
        la(a, function (a, e) {
            if (isArray(a))for (c = a.length; c--;)b.push(e + "=" + qa(a[c])); else b.push(e + "=" + qa(a))
        });
        return b.join("&")
    };
    function sa(a) {
    ...
    n.hasClass = function (a, b) {
        ...
        for (b = a.className.split(/\s+/).join(" "); d--;)if (!RegExp("(^| )" + c[d] + "( |$)").test(b))return false;
        return true
    };
                ...
                if (!c) {
                    ...
                    if (v && f === top) (function () {
                        ...
                        d.addEventListener("DOMContentLoaded",
                            g, false);
                        K(function () {
                            d.removeEventListener("DOMContentLoaded", g, false)
                        })
                    } else if (aa) {
                        var k;
                        (function () {
                    ...
                    f.attachEvent ? (f.attachEvent("onload", b), K(function () {
                            f.detachEvent("onload",
                                b)
                        })) : f.addEventListener && (f.addEventListener("load", b, false), K(function () {
                            f.removeEventListener("load", b, false)
                        }))
                }
            })();
            return function (a) {
    ...
    Qa.prototype.render = function () {
        ...
        var c = b.childNodes[0], a = oa(a, {
            domId: this.A,
            TIP_BACK_URL: "//ecma.bdimg.com/public03/imageplus/tip-back.png",
            ICON_URL: this.V ? "//ecma.bdimg.com/public03/imageplus/i_2.png" :
                "//ecma.bdimg.com/public03/imageplus/tip.png",
            ICON_HOVER_URL: this.V ? "//ecma.bdimg.com/public03/imageplus/i_2.png" : "//ecma.bdimg.com/public03/imageplus/tip-hover.png"
    ...
    function Sa(a, b) {
        ...
        if (!c) {
            ...
            a.a[c] = {f: b, h: d, u: {}, ya: {}, w: {}, o: {}, ha: 0, I: {}, aa: "", Wa: null, Va: false};
            a.m++
        }
        return c
    }
    ...
    function Ta(a, b, c) {
        ...
        if (a.f === b || D.contains(a.h, b))return true;
        var d = false;
        a.links && F(a.links, function (a) {
            if (a === b || D.contains(a, b))return d = true, false
        });
        return d
    }
    ...
    function Ua(a, b, c) {
        ...
        var e = e.o, f = c || "ALL";
        c = [];
        if (isArray(f)) c = f; else if ("ALL" === f)for (var g in a)a.hasOwnProperty(g) && c.push(g); else c = [f];
        f = [];
    ...
    R.prototype.closeAd = function (a) {
        var b = {usePrompt: true, reasons: "", availableReasons: null, canvas: "ALL", closeBy: "AD"};
        I(b, a || {}, true);
        a = b.canvas;
    ...
    R.prototype.getRenderInfos = function () {
        ...
        if (!a || !a.o)return b;
        var a = a.o, c = {}, d, e;
        for (e in a)a.hasOwnProperty(e) && (d = a[e], c[d.id] || (c[d.id] = true, b.push({id: d.id, url: d.url})));
        return b
    };
    ...
    function U(a) {
        ...
        var d = false, e = false, f = null, c = baidu.dom.getAncestorBy(a, function (b) {
            var c = D.getStyle(b, "position");
            if ("absolute" === c || "fixed" === c) e = true;
            if (Ya(b))return d = true;
            if (e && "static" === c || !Za(b))return false;
            f = $a(a, b);
            return f.clipped
        });
        if (!c)return L(a);
    ...
    function Za(a) {
        if ("HTML" === a.nodeName || "BODY" === a.nodeName)return false;
        var b = D.getStyle(a, "display"), c = D.getStyle(a, "float");
        return "inline" !== b || "none" !== c && "" !== c ? "visible" !== D.getStyle(a, "overflow") ? true : false : false
    }

    function $a(a, b) {
        var c = L(a), d = L(b), e = c.top, f = c.left, g = c.width, k = c.height, m = d.top, r = d.left, h = d.width, d = d.height;
        if (e >= m && f >= r && f + g <= r + h && e + k <= m + d)return c.clipped = false, c;
        c = {clipped: true};
                    ...
                    if (gb(c, g)) {
                        ...
                        c.getData(a, function (d) {
                            if (d && gb(c, g)) {
                                ...
                                for (var l, t, u, z, E = false, W = false, Gb = function (a, b, d) {
                                    if (a.imgIndex === l) {
                                ...
                                }, ua = 0, Hb = d.length; ua < Hb; ua++)if (t = d[ua], t.cproId && c.config.get("growCookie") && !c.qa && (c.qa = true, u = window.document.createElement("iframe"), u.style.cssText = "display: none;", u.src = c.config.get("growCookie") + "CPROID=" +
                                        t.cproId, window.document.body.appendChild(u)), u = t.ads, "product" === t.name && kb(c.config.get("unionId"), "c_" + (u || []).length), u.length) {
                                    for (var va = 0, Ib = u.length; va < Ib; va++)if (z = u[va], h === z.image) {
                                        var Wa = lb(c, t.render);
                                        if (Wa) {
                                            z.position_type = t.position_type;
                                            z.exp_list = t.exp_list;
                                            t.box && (z.box = z.box || {}, I(z.box, t.box, true));
                                            if (!W) {
                                                E = a[c.R];
                                                l = Sa(c, a);
                                                c.fa++;
                                                ...
                                                N.rect = E || W;
                                                N.Ra = g;
                                                X(c.config, W) ? N.inView = mb(c, a) : (N.inView = false, N.h.style.display = "none");
                                                W = true;
                                                c.addListener(l, "ALL",
                                                    "renderloaded", Gb)
                                            }
    ...
    n.getData = function (a, b, c) {
        if (location.href.match(/(\?|&)baiduImageplus=/)) b(window.baiduImagePlusFakeData); else {
            ...
            "https:" == document.location.protocol && (r.prot = 2);
            ...
            e = function (a,
                ...
                var e = {dri: ++d.ea};
                c && (e.is_small_pic = 1);
                b && d.C && (I(e, d.P[p % d.C]), p++);
                h(e, a)
            };
            if (c) e(b, false, true); else if (0 <= d.ta && d.T >= d.ta) e(b, true); else {
                var l = parseInt(d.config.get("yuetuFormId", 0) || 0, 10), t = false;
                0 < l && F(d.P || [], function (a) {
                    if (l === parseInt(a.formId || 0, 10))return t = true, false
                });
                var u = [], z = 0, E = d.C;
                1 > E && (E = 1);
                c = function (a) {
                ...
                if (1 > d.C) e(c, false); else for (a = 0; a < d.C; a++)e(c, true)
            }
        }
    };
    function ib(a, b) {
        if (a.complete) b(true); else {
            var c = function () {
                b(true);
                C(a, "load", c)
            };
    ...
    n.ka = function (a, b) {
        ...
        if (c) {
            ...
            if (D.contains(document.documentElement, c.f)) {
                ...
                if (e.top !== f.top || e.left !== f.left || e.width !== f.width || e.height !== f.height)if (c.rect = e, X(this.config, e)) pb(this, e, c.h), cb(this, d), ob(c.h, c.f), this.b(d, "resize", e); else if (d = this.getImgIndex(d)) c = this.a[d], c.inView = false, c.h.style.display = "none", this.b(d, "hide")
                ...
                if (d) {
                    var e = d.f, f = -1, g = {
                        ...
                        if (!(f >= c || g[m.nodeName])) {
                            f++;
                            var h;
                            if (h = 0 !== r)if ("a" === m.nodeName.toLowerCase() ? h = true : (h = D.getStyle(m, "cursor"), h = "pointer" === h || 0 === h.indexOf("url(")), h && (h = !D.contains(m, e))) {
                                h = L(m);
    ...
    function zb(a, b) {
        b = b || [];
        F(b, function (b) {
            if (!b || a.Aa[b.src] || !X(a.config, b) || !a.Oa.test(b.src))return true;
            a.Aa[b.src] = true;
    ...
    function Ab(a, b) {
        var c = {};
        if (c.immediate || !a.ca) a.ca = true, a.ja(b, function (d) {
            a.ca = false;
            var e = a.pa;
    ...
    function Z(a) {
        this.N = x({
            ...
            moreIgnoreGIFs: "",
            growCookie: "//imageplus.baidu.com/cookie_iframe.html?",
            vReg: /[?&]v=\w+(&|$)/i,
            noLogo: false,
        ...
        this.minHeight =
            parseInt(this.get("minImgHeight"), 10);
    ...
    function Cb(a, b) {
        ...
        var d = false;
        F(a.D, function (a) {
            if (a && (D.contains(a, b) || a === b))return d = true, false
        });
        return d
    }
    ...
    function db(a, b) {
        ...
        return c && c.specified || a.Ka.test(b.src) || Cb(a, b) || a.get("supportGIF") && (c = b.src, (c = (c = (c || "").match(a.Na)) ? c[1] : false) && a.Qa[c]) ? false : !!X(a, {
                width: b.offsetWidth,
    ...
    n.getData = function (a, b) {
        if (location.href.match(/(\?|&)baiduImageplus=/)) b(window.baiduImagePlusFakeData); else {
            ...
            var d = this.config.get("api"), e = this.config.get("unionId"), c = {
                ...
                k: c,
                "iurl[]": "//imageplus.baidu.com/imgs/showcase-1.jpg",
                qid: this.va,
                tu: e,
                width: 660,
                height: 370,
            ...
            "https:" == document.location.protocol && (c.prot = 2);
            d += -1 === d.indexOf("?") ? "?" : "&";
    ...
    n.go = function (a) {
        ...
        b.getData(a, function (a) {
            ...
            for (var g = 0, k = a.length; g < k; g++)if (c = a[g], d = c.ads, "product" === c.name && kb(b.config.get("unionId"), "c_" + (d || []).length), d.length)for (var m = 0, r = d.length; m < r; m++) {
                e = d[m];
                var h = lb(b, c.render);
                h && (e.position_type = c.position_type, e.exp_list = c.exp_list, c.box && (e.box = e.box || {}, I(e.box, c.box, true)), b.W({
                    url: h,
                    id: c.render_id
                }, e))
            }
    ...
    var qb = "160314", Nb = "http://bzclk.baidu.com/eye.php", Ob = "https:" == document.location.protocol;
    Ob && (Nb = "https://sp0.baidu.com/9q9JcDHa2gU2pMbgoY3K/eye.php");
    function kb(a, b) {
        baidu.sio.log(Nb + "?actionid=100&attach=" + a + "_" + b + "&timestamp=" + (new Date).getTime() + "_" + Math.floor(2147483648 * Math.random()).toString(36) + "&vn=" + qb)
    }
    ...
    function Pb(a) {
        ...
        function e(a) {
            return true === !isArray(a) || 1 > a.length ? false : true
        }

        var f = null, g = a.exp, k = Jb();
        k || b(c());
        k = Jb();
        if (true === !!g && true === e(g) && true === !!k) {
            f = x({}, a);
            f.expList = "";
            var m = d(k);
            F(g, function (a) {
    ...
    function Qb(a) {
        if (a.unionId) {
            a = Pb(a);
            var b = null;
            0 !== a.formList && (b = new Y(new Db(a || $)), b.n = Mb, b.H());
            a = a || $;
            (0 < parseInt(a.yuetuNopicFormId || 0, 10) || 0 < parseInt(a.yuetuNopicFloatFormId || 0, 10)) && (new Kb(new Eb(a))).H();
    ...
    if ("loading" !== $._status && "loaded" !== $._status) {
        ...
        var Rb = $.api || "//imageplus.baidu.com/ui", Sb = "&prot=1";
        Ob && (Sb = "&prot=2");
        Rb = Rb + (-1 === Rb.indexOf("?") ? "?" : "&") + "api=config" + Sb + "&tu=" + G($.unionId || "").replace(/^u/, "") + "&pic=" + document.getElementsByTagName("img").length + "&vn=" + qb;
        baidu.sio.callByServer(Rb, function (a) {
            Mb.site_api_loaded = (new Date).getTime();
            a = a || {};
            var b = x({}, a.union || {});
            0 === parseInt(a.confPriority,
                10) ? (b = x(b, a), Qb(x(b, $))) : (b = x(b, $), Qb(x(b, a)))
        }, {charset: "gbk", timeOut: 1E4, onfailure: Qb})
    }
    ;
